...
//	    eventHandler.push_back(
//			    gazebo::event::Events::ConnectAddEntity(
...
//======================================================================================   
    void RockBridge::worldCreated(std::string const& worldName)
    {
        ...
        gazebo::physics::WorldPtr world = gazebo::physics::get_world(worldName);
        if (!world)
        {
        ...
        gazebo::WorldTask* world_task = new gazebo::WorldTask();
        world_task->setGazeboWorld(world);
        setupTaskActivity(world_task);
		        
        typedef gazebo::physics::Model_V Model_V;
...
//======================================================================================
    void RockBridge::createTask(gazebo::physics::WorldPtr world, gazebo::physics::ModelPtr model)
    {
	    std::cout << " ~ " << std::endl;
...
//======================================================================================
    void RockBridge::updateBegin(gazebo::common::UpdateInfo const& info)
    {
